      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <input
            ...
            required
            maxLength={100}
            className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm outline-none transition-colors focus:border-disc-cyan/40 focus-visible:ring-2 focus-visible:ring-cyan-500"
          />
        </div>
        <div>
          ...
          <input
            ...
            required
            maxLength={500}
            className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 font-mono text-sm outline-none transition-colors focus:border-disc-cyan/40 focus-visible:ring-2 focus-visible:ring-cyan-500"
          />
        </div>
