                    ...
                    <div className="absolute right-0 mt-2 w-48 rounded-xl border border-white/10 bg-[#111] py-1 shadow-xl">
                      ...
                      {user.is_admin && (
                        <Link
                          href="/admin"
                          onClick={() => setUserMenuOpen(false)}
                          className="flex items-center gap-2 px-4 py-2 text-sm text-amber-400 transition-colors hover:bg-white/5 hover:text-amber-300"
                        >
                  ...
                  <>
                    ...
                    {user.is_admin && (
                      <Link
                        href="/admin"
                        onClick={() => setMobileOpen(false)}
                        className="block rounded-lg px-4 py-3 text-sm text-amber-400 transition-colors hover:bg-white/5 hover:text-amber-300"
                      >
                        Site Admin
                      </Link>
                    )}
