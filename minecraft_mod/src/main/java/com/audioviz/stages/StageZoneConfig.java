...
public class StageZoneConfig {
    ...
    public void setEntityCount(int entityCount) { this.entityCount = Math.max(1, Math.min(1000, entityCount)); }
    ...
    public void setBrightness(int brightness) { this.brightness = Math.max(0, Math.min(15, brightness)); }

    public boolean isGlowOnBeat() { return glowOnBeat; }
    public void setGlowOnBeat(boolean glowOnBeat) { this.glowOnBeat = glowOnBeat; }

    public float getIntensityMultiplier() { return intensityMultiplier; }
    public void setIntensityMultiplier(float v) { this.intensityMultiplier = Math.max(0.1f, Math.min(3.0f, v)); }
}
