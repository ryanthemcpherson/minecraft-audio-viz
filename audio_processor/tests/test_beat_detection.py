...
class MockAudioCapture:
    ...
    def __init__(self):
        ...
        # Initialize beat detection state (copy from __init__)
        self.capture._short_history = []
        self.capture._short_history_size = 6
        self.capture._long_history = []
        self.capture._long_history_size = 90
        self.capture._flux_history = []
        self.capture._flux_history_size = 30
        self.capture._prev_energy = 0.0
        self.capture._bass_flux_history = []
        self.capture._bass_flux_history_size = 20
        self.capture._prev_bass_energy = 0.0
        self.capture._last_beat_time = 0
        self.capture._min_beat_interval = 0.08
        self.capture._beat_cooldown = 0.0
        self.capture._beat_threshold = 1.3
        self.capture._onset_strength = 0.0
        self.capture._onset_history = []
        self.capture._onset_history_size = 15
        self.capture._bass_weight = 0.7
...
class TestBandGeneration:
    ...
    def test_bands_count(self):
        """Should always generate exactly 6 bands."""
        pass
