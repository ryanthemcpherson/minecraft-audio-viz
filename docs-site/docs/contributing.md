...
|-----------|-------------|
| Python VJ server | Add/update tests in `vj_server/tests/` |
| Coordinator | Add/update tests in `coordinator/tests/` |
| Java plugin | Build must succeed (`mvn package`) |
| Site | Lint and build must pass |

## Contributing Patterns

Custom visualization patterns are the top way to contribute to MCAV. Patterns are written in Lua and live in `patterns/*.lua`.

### Quick Start

1. Read the [Pattern Development Guide](guides/pattern-development.md) for complete documentation
...
Open a [Discussion](https://github.com/ryanthemcpherson/minecraft-audio-viz/discussions) or file an [Issue](https://github.com/ryanthemcpherson/minecraft-audio-viz/issues).
