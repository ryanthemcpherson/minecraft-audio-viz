...
public class CompositionManager {
    ...
    /**
     * Register a zone for composition management.
     */
    ...
    /**
     * Process all zones for one tick. Called from the main render loop.
     *
     * @param audio current audio state
     * @param time  elapsed time in seconds
     * @return map of zone → processed frame buffer (ready for renderer)
     */
    public Map<String, BitmapFrameBuffer> tick(AudioState audio, double time) {
        ...
        // Refresh game state if available
        ...
        for (Map.Entry<String, ZoneState> entry : zones.entrySet()) {
            ...
            if (transitioning) {
                ...
                if (!stillActive && zone.primaryPattern != null) {
                    // Transition complete — incoming is now primary
    ...
    /**
     * Switch pattern on a zone with a transition.
     */
    public void switchPattern(String zoneName, BitmapPattern newPattern,
        ...
        if (zone == null || zone.primaryPattern == null) {
            // No existing pattern — instant switch
    ...
    /**
     * Switch pattern on ALL zones simultaneously.
     */
    ...
    /**
     * Flash all zones to a color (beat drop effect).
     */
    ...
    /**
     * Set shared palette across all zones.
     */
    ...
    /**
     * Mirror a buffer horizontally into the output.
     */
    ...
    public enum SyncMode {
        ...
        INDEPENDENT,
        /** Secondary zones mirror the source zone horizontally. */
        MIRROR,
        /** All zones share the same pattern (unified wall). */
        UNIFIED
    }
    ...
    public static class ZoneState {
        ...
        /**
         * Enable secondary layer with a blend mode.
         */
